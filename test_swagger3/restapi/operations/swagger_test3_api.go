...
// NewSwaggerTest3API creates a new SwaggerTest3 instance
func NewSwaggerTest3API(spec *loads.Document) *SwaggerTest3API {
	return &SwaggerTest3API{
...
/*SwaggerTest3API The product of a tutorial on goswagger.io */
type SwaggerTest3API struct {
	spec            *loads.Document
...
func (o *SwaggerTest3API) SetDefaultProduces(mediaType string) {
	o.defaultProduces = mediaType
}

// SetDefaultConsumes returns the default consumes media type
func (o *SwaggerTest3API) SetDefaultConsumes(mediaType string) {
	o.defaultConsumes = mediaType
}

// SetSpec sets a spec that will be served for the clients.
func (o *SwaggerTest3API) SetSpec(spec *loads.Document) {
	o.spec = spec
}

// DefaultProduces returns the default produces media type
func (o *SwaggerTest3API) DefaultProduces() string {
	return o.defaultProduces
}

// DefaultConsumes returns the default consumes media type
func (o *SwaggerTest3API) DefaultConsumes() string {
	return o.defaultConsumes
}

// Formats returns the registered string formats
func (o *SwaggerTest3API) Formats() strfmt.Registry {
	return o.formats
}

// RegisterFormat registers a custom format validator
func (o *SwaggerTest3API) RegisterFormat(name string, format strfmt.Format, validator strfmt.Validator) {
	o.formats.Add(name, format, validator)
}

// Validate validates the registrations in the SwaggerTest3API
func (o *SwaggerTest3API) Validate() error {
...
func (o *SwaggerTest3API) ServeErrorFor(operationID string) func(http.ResponseWriter, *http.Request, error) {
	return o.ServeError
}

// AuthenticatorsFor gets the authenticators for the specified security schemes
func (o *SwaggerTest3API) AuthenticatorsFor(schemes map[string]spec.SecurityScheme) map[string]runtime.Authenticator {
...
func (o *SwaggerTest3API) Authorizer() runtime.Authorizer {
...
func (o *SwaggerTest3API) ConsumersFor(mediaTypes []string) map[string]runtime.Consumer {
...
func (o *SwaggerTest3API) ProducersFor(mediaTypes []string) map[string]runtime.Producer {
...
func (o *SwaggerTest3API) HandlerFor(method, path string) (http.Handler, bool) {
	if o.handlers == nil {
		return nil, false
	}
...
// Context returns the middleware context for the swagger test3 API
func (o *SwaggerTest3API) Context() *middleware.Context {
	if o.context == nil {
...
func (o *SwaggerTest3API) initHandlerCache() {
...
func (o *SwaggerTest3API) Serve(builder middleware.Builder) http.Handler {
	o.Init()
...
func (o *SwaggerTest3API) RegisterConsumer(mediaType string, consumer runtime.Consumer) {
	o.customConsumers[mediaType] = consumer
}

// RegisterProducer allows you to add (or override) a producer for a media type.
func (o *SwaggerTest3API) RegisterProducer(mediaType string, producer runtime.Producer) {
