...
import (
	...
	"test_swagger3/restapi/operations"
	"test_swagger3/restapi/operations/todos"
)

//go:generate swagger generate server --target .. --name swagger_test3 --spec ../swagger3.yml

func configureFlags(api *operations.SwaggerTest3API) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.SwaggerTest3API) http.Handler {
